"""Exactly the 14 frozen v0.1.3 acceptance scenarios."""
...
if len(SCENARIO_FILES) != 14:
    raise RuntimeError(f"Frozen scenario set must contain exactly 14 files, found {len(SCENARIO_FILES)}")
